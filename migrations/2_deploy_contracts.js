...
module.exports = async function(deployer, _network, accounts) {
  ...
  await dex.createLimitOrder(YFI, 1000, 2, SIDE.BUY, {from: trader1});
  await dex.createMarketOrder(YFI, 1000, SIDE.SELL, {from: trader2});
  await increaseTime(1);
  await dex.createLimitOrder(YFI, 500, 4, SIDE.BUY, {from: trader1});
  await dex.createMarketOrder(YFI, 500, SIDE.SELL, {from: trader2});
  await increaseTime(1);
  await dex.createLimitOrder(YFI, 800, 2, SIDE.BUY, {from: trader1});
  await dex.createMarketOrder(YFI, 800, SIDE.SELL, {from: trader2});
  await increaseTime(1);
  await dex.createLimitOrder(YFI, 1200, 6, SIDE.BUY, {from: trader1});
  await dex.createMarketOrder(YFI, 1200, SIDE.SELL, {from: trader2});
  ...
  await Promise.all([
    ...
    dex.createLimitOrder(YFI, 3000, 4, SIDE.BUY, {from: trader1}),
    dex.createLimitOrder(YFI, 2000, 5, SIDE.BUY, {from: trader1}),
    dex.createLimitOrder(YFI, 500, 6, SIDE.BUY, {from: trader2}),

    dex.createLimitOrder(CWV, 4000, 12, SIDE.BUY, {from: trader1}),
    dex.createLimitOrder(CWV, 3000, 13, SIDE.BUY, {from: trader1}),
    dex.createLimitOrder(CWV, 500, 14, SIDE.BUY, {from: trader2}),
    ...
    dex.createLimitOrder(YFI, 4000, 10, SIDE.SELL, {from: trader3}),
    dex.createLimitOrder(YFI, 2000, 9, SIDE.SELL, {from: trader3}),
    dex.createLimitOrder(YFI, 800, 8, SIDE.SELL, {from: trader4}),

    dex.createLimitOrder(CWV, 1500, 23, SIDE.SELL, {from: trader3}),
    dex.createLimitOrder(CWV, 1200, 22, SIDE.SELL, {from: trader3}),
    dex.createLimitOrder(CWV, 900, 21, SIDE.SELL, {from: trader4}),
  ]);
};
